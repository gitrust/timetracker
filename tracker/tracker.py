...
class Tracker:
    ...
    def printhelp(self,cmd):
        ...
        print(" pause,p\tset pause task as active")
        print(" push\t\tpush all done tasks to storage and remove them from current list")
        print(" rename,ren\trename a task by id")
        print(" remove,rm\tdelete a task by id")
